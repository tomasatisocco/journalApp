...
class LoginBloc with Validators{
  ...
  Sink<String> get loginOrCreateChanged => _loginOrCreateButtonController.sink;
  Stream<String> get loginOrCreate => _loginOrCreateButtonController.stream;
